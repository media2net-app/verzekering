...
export const insuranceTypes: InsuranceType[] = [
  ...
  },
  {
    ...
    category: 'auto',
    description: 'Verzekering voor uw motor',
    basePrice: 35,
    questions: [
      {
        id: 'motor_kenteken',
        ...
        placeholder: 'Bijv. 12-ABC-3',
        required: true,
        tooltip: 'Het kenteken van uw motor staat op het kentekenbewijs. Voer het in zonder spaties.',
      },
      {
        id: 'motor_merk',
        type: 'text',
        label: 'Merk en model',
        required: true,
        tooltip: 'Vul het volledige merk en model van uw motor in zoals vermeld op het kentekenbewijs.',
      },
      {
        id: 'motor_bouwjaar',
        type: 'number',
        ...
        placeholder: 'Bijv. 2020',
        required: true,
        tooltip: 'Het bouwjaar is het jaar waarin uw motor voor het eerst is toegelaten tot het verkeer.',
      },
      {
        id: 'motor_schadevrije_jaren',
        type: 'number',
        label: 'Aantal schadevrije jaren',
        placeholder: '0',
        required: false,
  ...
  },
  {
    ...
    category: 'auto',
    description: 'Verzekering voor uw caravan',
    basePrice: 20,
    questions: [
      {
        id: 'caravan_merk',
        type: 'text',
        label: 'Merk en model',
        placeholder: 'Bijv. Hobby Premium',
        required: true,
        tooltip: 'Vul het volledige merk en model van uw caravan in.',
      },
      {
        id: 'caravan_waarde',
        type: 'number',
        label: 'Waarde van uw caravan (€)',
        placeholder: 'Bijv. 15000',
        required: true,
        tooltip: 'De waarde van uw caravan is de aankoopprijs of de huidige marktwaarde.',
      },
      {
        id: 'caravan_bouwjaar',
        type: 'number',
        ...
        placeholder: 'Bijv. 2020',
        required: true,
        tooltip: 'Het bouwjaar is het jaar waarin uw caravan is gebouwd.',
      },
    ],
  },
];
